...
// NULL is used for empty/non-existent key positions
...
const enum CrossPlatformKeyCode keyboard_matrix[6][17] = {
    // Row 0: Function keys row
    {
        ...
        KEY_PRINT_SCREEN, KEY_SCROLL_LOCK, KEY_PAUSE, NULL
    },
    ...
    // Row 3: ASDF row
    {
        ...
        KEY_ENTER, NULL, NULL, NULL, NULL
    },

    // Row 4: ZXCV row
    {
        KEY_SHIFT_LEFT, NULL, KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
        KEY_SHIFT_RIGHT, NULL, KEY_UP, NULL, NULL
    },

    // Row 5: Bottom row
    {
        KEY_CONTROL_LEFT, KEY_SUPER_LEFT, KEY_ALT_LEFT, KEY_SPACE, KEY_ALT_RIGHT, KEY_SUPER_RIGHT, KEY_MENU,
        KEY_CONTROL_RIGHT, NULL, NULL, NULL, NULL, NULL, KEY_LEFT, KEY_DOWN, KEY_RIGHT, NULL
    }
};